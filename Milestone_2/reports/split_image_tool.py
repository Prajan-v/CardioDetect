...
input_path = base_dir / 'code_tesseract.png'
output1 = base_dir / 'code_tesseract_left.png'
output2 = base_dir / 'code_tesseract_right.png'
...
if input_path.exists():
    ...
    # The user wants "parallel view", which usually means Left Column = Top half, Right Column = Bottom half
    mid_point = height // 2
